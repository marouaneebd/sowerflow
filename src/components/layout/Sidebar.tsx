    ...
    return (
      <button onClick={() => setPage(name)}>
        <li
          ...
          ${active
              ? "bg-gradient-to-tr bg-gray-100 text-gray-850"
      ...
      `}
        >
          ...
          {alert && (
            <div
              className={`absolute right-2 w-2 h-2 rounded bg-gray-100 ${expanded ? "" : "top-2"
                }`}
            />
          )}
      ...
      <nav className="h-full flex flex-col bg-gray-900 shadow-sm">
        <div className="p-4 pb-2 flex justify-between items-center">
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-gray-850 hover:bg-gray-600"
          >
